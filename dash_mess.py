...
app_colors = {
    'background': '#CECECE',
    'text': '#000000',
    'sentiment-plot':'#FF0000',
    'volume-bar':'#0000FF',
    'someothercolor':'#A52A2A',
}
...
app.layout = html.Div(
    [   html.Div(className='container-fluid', children=[html.H2('Uji-Coba-Live Twitter Sentimen-BBPSDMP Makassar', style={'color':"#000000"}),
                                                        html.H5('Search:', style={'color':app_colors['text']}),
                                                  dcc.Input(id='sentiment_term', value='indonesia', type='text', style={'color':app_colors['someothercolor']}),
                                                  ],
